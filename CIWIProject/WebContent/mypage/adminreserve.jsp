		...
		<div class="text-center"><br><br>
			<div class="container">
				...
				<tr class="warning">
					...
					<th width=10% class="text-center">예매일</th>
				...
				<c:forEach var="vo" items="${list }">
					...
					<c:if test="${vo.r_state==0}">
							<td width=10% class="text-center">
								<input type=button value="승인완료" class="cashOkBtn btn btn-sm btn-info" data-id=${vo.r_id}>
							</td>
					</c:if>
					<c:if test="${vo.r_state==1 }">
							<td width=10% class="text-center">결제완료</td>
					</c:if>
					</td>
					</tr>
				</c:forEach>
